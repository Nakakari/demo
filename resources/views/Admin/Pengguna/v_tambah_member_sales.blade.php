        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('pengguna.list-member', $uuid) }}">List Member</a>
                    </li>
        ...
        <div class="card-body">
            ...
            <div class="card border-top border-0 border-4 border-primary">
                <div class="card-body p-5">
                    ...
                    <hr>
                    <p>Tambah Member untuk akun sales: <b>{{ $user->name }}</b></p>
                    <hr>
                    <form id="form-addPengiriman" class="row g-3" action="{{ route('pengguna.save-member', $uuid) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="id_sales" value="{{ $user->id }}">
                            @if ($errors->has('kode'))
