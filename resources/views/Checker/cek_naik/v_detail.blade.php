            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="/checker_naik/{{ base64_encode(Auth::user()->id_cabang) }}"><i class="bx bx-up-arrow"></i></a></li>
                        <li class="breadcrumb-item"><a href="/resi_naik/{{ base64_encode($id_cek) }}">Detail Resi Naik dari Driver {{$cek->driver}}</a></li>
...
@section('js')
    <script type="text/javascript">
        ...
        const table = $("#resi-dt").DataTable({
            ...
            "scrollX": true,
            "ajax": {
                url: "{{ url('/list_detail/' . base64_encode($id_cek) .'/'. base64_encode($id_pengiriman)) }}",
                type: "POST",
                data: function(d) {
                    d._token = "{{ csrf_token() }}"
                }
