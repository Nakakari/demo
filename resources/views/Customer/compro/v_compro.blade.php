    ...
    <header>
        ...
        <div class="container">
            ...
            <div class="row nomargin">
                <div class="span4">
                    <div class="logo">
                        <a href="index.html"><img src="{{ asset('template_compro') }}/assets/img/logo.png" alt="" /></a>
                    </div>
                </div>
                <div class="span8">
                                ...
                                <ul class="nav topnav">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="{{ asset('template_compro') }}/assets/icons.html">Icons</a></li>
                                            <li><a href="{{ asset('template_compro') }}/assets/icon-variations.html">Icon variations</a></li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="span12 aligncenter">
                                ...
                                <img src="{{ asset('template_compro') }}/assets/img/slides/camera/slide3/browsers.png" alt="" class="animated bounceInDown delay1" />
                            </div>
                        </div>
                    </div>
                </div>
