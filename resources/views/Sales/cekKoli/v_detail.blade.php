    ...
    @if ($id_cabang == Auth::user()->id_cabang)
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="/sales_checker_naik/{{ base64_encode(Auth::user()->id_cabang) }}"><i class="bx bx-up-arrow"></i></a></li>
                        <li class="breadcrumb-item"><a href="/sales_resi_naik/{{ base64_encode($id_cek) }}">Detail Resi Naik dari Driver {{$cek->driver}}</a></li>
        ...
        <div class="card radius-10">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <h6 class="mb-2">Data detail koli naik</h6>
                        <div class="col-12">
                            <p>Daftar data detail koli naik untuk Driver
...
@section('js')
    <script type="text/javascript">
        ...
        const table = $("#resi-dt").DataTable({
            ...
            "scrollX": true,
            "ajax": {
                url: "{{ url('/sales_list_detail/' . base64_encode($id_cek) .'/'. base64_encode($id_pengiriman)) }}",
                type: "POST",
                data: function(d) {
                    d._token = "{{ csrf_token() }}"
                }
