    ...
    @if ($id_cabang == Auth::user()->id_cabang)
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            Detail Resi Naik dari Driver {{$cek->driver}}
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card radius-10">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <h6 class="mb-2">Data detail Resi naik</h6>
                        <div class="col-12">
                            <p>Daftar data detail Resi naik untuk Driver
...
@section('js')
    <script type="text/javascript">
        ...
        const table = $("#resi-dt").DataTable({
            ...
            "scrollX": true,
            "ajax": {
                url: "{{ url('/sales_resi_detail/' . base64_encode($id_cek)) }}",
                type: "POST",
                data: function(d) {
                    d._token = "{{ csrf_token() }}"
                }
            ...
            "columnDefs": [{
                ...
                "data": "id_pengiriman",
                "render": function(data, type, row, meta) {
                    const url_print = "/sales_detail_naik/{{base64_encode($id_cek)}}/" + btoa(data);
