...
<body onload="window.print();">
    ...
    <table width="100%">
        <tr>
            <td width="10%">
                <img src="{{ url('') }}{{ logo_instansi() }}" style="height: 116px" alt="">
            </td>
    ...
    <table width="100%" style="border-collapse:collapse; margin-bottom: 10px">
        <tr style="min-height: 80px; max-height: 80px;">
            <td width="35%"
                style="padding-left: 12px; padding-right: 2px; vertical-align: top; text-transform: capitalize; text-align: center">
            ...
            <td width="30%" style="vertical-align: top; text-align: center">
                <div class="visible-print text-center">
                    {!! QrCode::size(60)->generate(
                        route('pengiriman', base64_encode($pengiriman->dari_cabang)) . '?cari_print=' . $pengiriman->no_resi,
                    ) !!}
                </div>
            </td>
        </tr>
    ...
    <table width="100%">
        <tr>
            ...
            <td style="vertical-align: top; font-size: 11.5px; line-height: 90%;" width="50%">
                ...
                <b>9. KRITIK DAN SARAN HUB. WA {{ wa() }}</b>
            </td>
            <td width="15%" style="vertical-align: top; text-align: center;">
